...
public class OnlineStoreService {
    ...
    Customer chara = new Customer("Chara Pastrana", LocalDate.of(1954, 4, 26), "7592 College Dr.Fishers, IN 46037",
            Gender.FEMALE, "(815) 203-5480", new int[]{2, 4, 12}, LocalDate.of(2017, 6, 1));
    ...
    Customer nikki = new Customer("Nikki Sturges", LocalDate.of(1964, 8, 11), "457 St Paul Street Utica, NY 13501",
            Gender.FEMALE, "(284) 755-7619", new int[]{11}, LocalDate.of(2017, 6, 9));
    ...
    public static void setCustomerList(List<Customer> customerList) {
        OnlineStoreService.customerList = customerList;
    }
    ...
    public static void setItemList(List<Item> itemList) {
        OnlineStoreService.itemList = itemList;
    }

    public static int calculatePeriod (LocalDate startDate, LocalDate endDate){
